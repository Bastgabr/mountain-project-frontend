 ...
 * @param selectedLang 
 */
function UpdateLangageMenu(selectedLang : string){
  if(selectedLang == null ||selectedLang == 'undefined' ) selectedLang = enLangCode;
 ...
 * @returns 
 */
function LangCodeToSrc(langCode: string){
 ...
 */
function SrcToLangCode(srcPath: string){
  switch(srcPath){
    case frLangImg: {
      return frLangCode;
    }
